...
final class CurrencyPairViewController: UIViewController {
    ...
    private enum FilterType { case all, fiat, crypto }
    ...
    private func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            filterSegment.topAnchor.constraint(equalTo: rateLabel.bottomAnchor, constant: Layout.elementSpacing),
    ...
    @objc private func filterChanged() {
        ...
        case 1:  currentFilter = .fiat
        case 2:  currentFilter = .crypto
    ...
    private func applyFilter() {
        ...
        case .all:    displayedCurrencies = allCurrencies
        case .fiat:   displayedCurrencies = allCurrencies.filter { $0.type == .fiat }
        case .crypto: displayedCurrencies = allCurrencies.filter { $0.type == .crypto }
        }
        collectionView.reloadData()
    }
    ...
    private func updateTimerUI() {
        timerLabel.text = "\(MessagesToUser.secondsToRefresh) \(secondsLeft)"
    }
}
...
extension CurrencyPairViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(with: currency, isDisabled: isDisabled)
        return cell
    }
}
...
private extension CurrencyPairViewController {
    ...
    enum MessagesToUser {
        ...
        static let secondsToRefresh: String = "До обновления курса:"
    }
