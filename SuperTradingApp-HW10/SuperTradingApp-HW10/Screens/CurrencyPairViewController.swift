...
private extension CurrencyPairViewController {
    ...
    func setupCollectionView() {
        ...
        layout.sectionInset = UIEdgeInsets(top: CollectionLayout.sectionInset, left: 0, bottom: CollectionLayout.sectionInset, right: 0)
...
private extension CurrencyPairViewController {
    ...
    enum MessagesToUser {
        static let title = "Все валюты"
        static let placeholder = "Введите сумму..."
        static let emptyFavorites = "☆ Нет избранных валют.\nДобавьте валюты, нажав на звёздочку."
    }
