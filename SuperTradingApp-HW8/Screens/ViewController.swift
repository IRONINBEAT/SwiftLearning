...
private extension ViewController {
    ...
    func setupUI() {
        ...
        // Pair Button
        pairButton.setTitle("Выбрать пару", for: .normal)
        pairButton.backgroundColor = .systemBlue
        pairButton.setTitleColor(.white, for: .normal)
        pairButton.titleLabel?.font = .boldSystemFont(ofSize: Fonts.textFontSize)
        pairButton.layer.cornerRadius = Layout.buttonCornerRadius
    ...
    func makeConstraints() {
        NSLayoutConstraint.activate([
            ...
            tableView.bottomAnchor.constraint(equalTo: pairButton.topAnchor, constant: -Layout.elementSpacing),
            
            emptyStateLabel.centerXAnchor.constraint(equalTo: tableView.centerXAnchor),
            emptyStateLabel.centerYAnchor.constraint(equalTo: tableView.centerYAnchor),
            
            pairButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: Layout.sidePadding),
            pairButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -Layout.sidePadding),
            pairButton.bottomAnchor.constraint(equalTo: runButton.topAnchor, constant: -10),
            pairButton.heightAnchor.constraint(equalToConstant: Layout.buttonHeight),
