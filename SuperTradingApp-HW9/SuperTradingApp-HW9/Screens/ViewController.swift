...
private extension ViewController {
    ...
    func makeConstraints() {
        NSLayoutConstraint.activate([
            ...
            pairHintLabel.topAnchor.constraint(equalTo: currentPairButton.bottomAnchor, constant: Layout.hintTopSpacing),
...
private extension ViewController {
    ...
    enum MessagesToUser {
        ...
        static let pairHint = "Нажмите на текущую пару, чтобы изменить валюты"
    }
